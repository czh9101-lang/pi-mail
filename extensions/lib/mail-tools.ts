...
export interface MailToolCtx { client: MailClient | null; connected: boolean; agentId: string; agentName: string; nameCustomized: boolean; mailbox: MailMessage[]; notConnected: { content: { type: "text"; text: string }[] }; agentStatus: string; updateStatus: (ctx?: unknown) => void; }
